...
class MultiphaseBlockPreconditioner:
    ...
    def get_thn_vals(self, n, row_on_grid, col_on_grid, is_ths: bool=False):
        dx = self.dx
        dy = self.dy
    ...
    def get_block_matrices(self, n, xi, is_ths: bool=False):
        dx = self.dx
        dy = self.dy
...
if __name__ == "__main__":
    ...
    L_n, D_n, XI_n, G_n = block_prec.get_block_matrices(n, xi, is_ths=False)
    L_s, D_s, XI_s, G_s = block_prec.get_block_matrices(n, xi, is_ths=True)
